...
function buildGauge(metaId) {
    d3.json("samples.json").then(function (data){
        ...
        var data = [
            {
                ...
                mode: "gauge+number",
                gauge: { 
                    bar: { color: "rgb(231,250,90)" },
                    axis: { range: [null, 9], tickcolor: "rgb(231,250,90)"},
                       steps: [
                        { range: [0, 2], color: "rgb 229,245,224" },
                        { range: [2, 4], color: "rgb 199,233,192" },
                        { range: [4, 6], color: "rgb 161,217,155" },
                        { range: [6, 8], color: "rgb 116,196,118" },
                        { range: [8, 9], color: "rgb 65,171,93" },
        ...
        var layout_g = { 
            width: 650, 
            height: 550, 
            margin: { t: 20, b: 140, l:10, r:100 } 
          }
          Plotly.newPlot('gauge', data, layout_g);
